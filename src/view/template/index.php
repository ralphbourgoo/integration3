<main>
  ...
  <section class="socials_wrapper">
    <p class="socials_text">Blijf op de hooghte ! Volg ons op <a href="">Facebook</a>, <a href="">Instagram</a>, <a href="">Twitter</a>. Of schrijf je in op onze newsletter.</p>
  </section>
  <section class="faire_wrapper">
    <img src="assets/img/logo/logo.svg" class="logo_home" alt="logo makersfaire">
    <h2 class="subtitle">Makers Faire Ghent 2021</h2>
    <p class="text">Door COVID-19 is onze vorige editie helaas niet kunnen doorgaan. Maar treur niet creatieve vrienden, wij zorgen ervoor dat jullie creativiteit beloond wordt. Ga aan de slag met verschillende <span>tutorials</span> en bouw de gekste dingen. Het thema dit trimester zijn voertuigen die kunnen vliegen. Ga van start en bouw samen met ons een <span>luchtballon</span> !</p>
    <div class="button_wrapper">
