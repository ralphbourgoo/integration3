<main>
  ...
  <section class="product_wrapper <?php echo $product['reverse'];?>">
    ...
    <div class="winkel_wrap">
      ...
      <div class="button_wrapper nocenter button_winkel">
        <a class="button__inverse" href="index.php?page=tutorial">Start Tutorial</a>
        <form class="add_form" method="post" action="index.php?page=winkelwagen">
          <input type="hidden" name="id" value="<?php echo $product['id'];?>" />
          <button class="button nowrap" type="submit" name="action" value="add">In Winkelwagen</button>
        </form>
      </div>
    </div>
  </section>
